...
public class Usuario {
	...
	public double cancelarReserva(Reserva reserva, LocalDate hoy) {
        double reembolso = reserva.getPropiedad().cancelarReserva(reserva, hoy);
        if (reembolso > 0) {
            this.reservas.remove(reserva);
            System.out.println("reserva cancelada. Monto de reembolso: $" + reembolso);
        } else {
            System.out.println("la reserva no se puede cancelar o no hay reembolso.");
        }
        return reembolso;
    }
